...
ENV_VARS="DROIDLM_DEBUG_LOG_BUCKET=${BUCKET},DROIDLM_DEBUG_LOG_PREFIX=${PREFIX},DROIDLM_MAX_DEBUG_LOG_BYTES=${MAX_BYTES},DROIDLM_DEBUG_LOG_PROJECT=${PROJECT},DROIDLM_FIREBASE_PROJECT_ID=${FIREBASE_PROJECT},DROIDLM_ALLOWLIST_PROJECT=${ALLOWLIST_PROJECT},DROIDLM_ALLOWLIST_COLLECTION=${ALLOWLIST_COLLECTION},DROIDLM_ALLOWLIST_HMAC_SECRET=${ALLOWLIST_HMAC_SECRET}"
CMD=(
